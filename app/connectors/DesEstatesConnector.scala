...
class DesEstatesConnector @Inject() (http: HttpClientV2, config: AppConfig, estates5MLDService: Estates5MLDService)(
  implicit ec: ExecutionContext
) extends Logging with EstatesConnector {

  private lazy val estatesServiceUrl: String = s"${config.desRegistrationBaseUrl}/estates"
